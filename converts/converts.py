...
def is_infix(value):
  value = value.replace(" " , "")
  is_operation(value)
  if value[0] in main_operators or value[-1] in main_operators:
...
def is_postfix(value):
  value = value.replace(" " , "")
  is_operation(value)
  if value[0] in main_operators or value[-1] not in main_operators:
...
def is_prefix(value):
  value = value.replace(" " , "")
  is_operation(value)
  if value[0] not in main_operators or value[-1] in main_operators:
